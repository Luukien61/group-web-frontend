...
const Test = () => {
    ...
    return (
        <div className={`w-1/3 p-4`}>
            <div id="toast-danger"
                 className={`flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow duration-300 ease-in-out ${isDisplay ? 'translate-y-1/2' : '-translate-y-[100px] hidden'}`}
                 role="alert">
                <div
