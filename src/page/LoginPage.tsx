            ...
            <input
                ...
                className={`block py-2.5 px-3 w-full autofill:bg-white border rounded border-default_green text-sm
                 text-gray-900 bg-transparent appearance-none focus:outline-none
                  focus:ring-0 focus:border-blue-600 peer focus:blue-growing-border ${style}`}
                placeholder=" "
                required
            />
            <div
                className="bg-white pl-2 peer-focus:p-0 z-10 start-1 peer-focus:start-1 peer-focus:z-10 scale-75 text-[20px] text-blue-600 peer-focus:font-medium absolute peer-focus:text-[20px]  -translate-y-6 duration-300 top-3 origin-left peer-placeholder-shown:-z-10 rtl:peer-focus:translate-x-1/4  peer-focus:text-blue-600  peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                <p>{label}</p>
            </div>
        </div>
    );
